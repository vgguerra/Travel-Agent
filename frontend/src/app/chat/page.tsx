...
import { Plane, RotateCcw, LogOut } from "lucide-react";
...
export default function ChatPage() {
  ...
  const { messages, loading, error, sessionId, travelState, send, reset, newChat, loadSession } =
    useChat();
  ...
  return (
    <div className="h-screen flex bg-[var(--background)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="shrink-0 flex items-center justify-between px-4 sm:px-6 h-14 border-b border-white/5 bg-[var(--background)]/80 backdrop-blur-md z-20">
          <div className="flex items-center gap-2.5">
            ...
            {userName && (
              <>
                ...
                <span className="text-white/35 text-xs hidden sm:inline">{userName}</span>
              </>
            )}
          </div>
                ...
                >
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-white/40 text-sm max-w-sm mx-auto leading-relaxed">
                      Me conte os detalhes da sua viagem e eu preparo um plano completo com clima,
                      atracoes, voos e hospedagem.
                    </p>
                  </div>
        ...
        {/* Input */}
        <div className="shrink-0 border-t border-white/5 bg-[var(--background)]/80 backdrop-blur-md">
